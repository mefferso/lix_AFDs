...
from collect_sounding_images import collect_sounding_images
...
def main() -> None:
    ...
    collect_sounding_images(package_dir, config)
    ...
    print(f"Sounding images: {package_dir / 'sounding_images' / 'sounding_images_manifest.json'}")
